<%@ page import="com.tekdays.TekUser; com.tekdays.Sponsor; com.tekdays.TekEvent" %>
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'endDate', 'error')} required">
    ...
    <g:datePicker name="endDate" precision="day" value="${tekEventInstance?.endDate}" years="${2020..2030}"/>
