...
<div class="fieldcontain ${hasErrors(bean: sponsorshipInstance, field: 'event', 'error')} required">
    ...
    <g:select id="event" name="event.id" from="${com.tekdays.TekEvent.list()}" optionKey="id" required=""
              value="${sponsorshipInstance?.event?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: sponsorshipInstance, field: 'sponsor', 'error')} required">
    ...
    <g:select id="sponsor" name="sponsor.id" from="${com.tekdays.Sponsor.list()}" optionKey="id" required=""
              value="${sponsorshipInstance?.sponsor?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: sponsorshipInstance, field: 'contributionType', 'error')} required">
    ...
    <g:select name="contributionType" from="${sponsorshipInstance.constraints.contributionType.inList}" required=""
              value="${sponsorshipInstance?.contributionType}" valueMessagePrefix="sponsorship.contributionType"/>
